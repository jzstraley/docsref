...
* Diagnosis: EKG to Confirm
    ...
    * Exercise stress test after starting meds
...
* [Rate vs Rhythm Control in Recurrent Persistent Afib][14]
* [Early Rhythm Control][15]
    * Goal: HR<80 if symptoms, HR <110 if none, EF >40% 
        * EAST-AFNET 4*
            * Improved clinical outcomes if early rhythm control in all patients diagnosed within the past 12 months w/coexisting CVD
            * Aggressive rhythm control via Ablation or Amio
...
* Radiofrequency Ablation (RFA)
    ...
    *   Afib recurrance after RFA in 20-40% of patients
        ...
        * [Repeat ablation][17] is primarily considered for those with symptomatic AF recurrences (often drug-refactory) occurring at least 3 months or more post-ablation
    ...
    * Complications (<5%)
        ...
        * Acute Pericarditis (10.2%)
            * [Associated with younger age][16]
...
[^1]: https://www.ncbi.nlm.nih.gov/books/NBK526072/{:target="_blank"}
